...
# class UAVConsumer(AsyncWebsocketConsumer):
    
#     async def connect(self):
        
#         self.group_name = 'uav_consumer'
...
#             pose_linear_x = data['data']['pose_linear_x']
#             pose_linear_y = data['data']['pose_linear_y']
#             pose_linear_z = data['data']['pose_linear_z']

#             pose_angular_x = data['data']['pose_angular_x']
#             pose_angular_y = data['data']['pose_angular_y']
#             pose_angular_z = data['data']['pose_angular_z']
#             pose_angular_w = data['data']['pose_angular_w']

#             await self.channel_layer.group_send(
#             self.group_name,
#             {
#                 'type': 'pose_data',
#                 'pose_linear_x': pose_linear_x,
#                 'pose_linear_y': pose_linear_y,
#                 'pose_linear_z': pose_linear_z,
#                 'pose_angular_x': pose_angular_x,
#                 'pose_angular_y': pose_angular_y,
#                 'pose_angular_z': pose_angular_z,
#                 'pose_angular_w': pose_angular_w,
#             })
...
#     async def pose_data(self, event):
#         # This method handles messages received by the group.
#         # It sends the location data to all clients in the group.

#         pose_linear_x = event['pose_linear_x']
#         pose_linear_y = event['pose_linear_y']
#         pose_linear_z = event['pose_linear_z']

#         pose_angular_x = event['pose_angular_x']
#         pose_angular_y = event['pose_angular_y']
#         pose_angular_z = event['pose_angular_z']
#         pose_angular_w = event['pose_angular_w']
